...
var trafficSessionKey="vp_revenue_session_v2:"+routeId;
try{if(!sessionStorage.getItem(trafficSessionKey)){posthog.capture("traffic_session_start",common,instant);sessionStorage.setItem(trafficSessionKey,"1")}}catch(_e){posthog.capture("traffic_session_start",common,instant)}
